...
Let us first explore the different parent organizations:
```{r}
PO_enrollment=enr_10000 %>%
  group_by(`Parent Organization`) %>%
  summarize(all_enr=sum(tot_enr))
```


Once we have determined which variables we are going to be looking at
